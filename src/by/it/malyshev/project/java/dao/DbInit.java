...
import by.it.malyshev.project.java.connection.ConnectionCreatorIni;
...
public class DbInit {
    ...
    public static void main(String[] args) {
        ...
        try (Connection connection= ConnectionCreatorIni.getConnection();
            ...
            statement.executeUpdate("INSERT INTO `malyshev`.`roles`(`ID`, `role`)VALUES(2, 'User'); ");
            statement.executeUpdate("INSERT INTO `malyshev`.`roles`(`ID`, `role`)VALUES(3, 'Guest'); ");
            ...
            statement.executeUpdate("INSERT INTO `malyshev`.`authorsBooks`(`ID`,`authors_ID`, `books_ID`)VALUES(1, 1, 1); ");
            statement.executeUpdate("INSERT INTO `malyshev`.`authorsBooks`(`ID`,`authors_ID`, `books_ID`)VALUES(2, 2, 2); ");
