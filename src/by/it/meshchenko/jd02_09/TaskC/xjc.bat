...
set path_xjc="C:\Program Files\Java\jdk1.8.0_144\bin\xjc.exe"
set path_to_src="D:\MyDocuments\DEVELOPMENT\Java\JD2017-09-20\src\
set file_xcd="D:\MyDocuments\DEVELOPMENT\Java\JD2017-09-20\src\by\it\meshchenko\jd02_09\TaskC\ShoppingCenters.xsd"
