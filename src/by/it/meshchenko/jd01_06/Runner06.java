...
public class Runner06 {
    public static void main(String[] args){
        ...
        // C.2
        // Сложить из случайных слов стихотворения строку String ровно (!) в один миллион
        // символов путем конкатенации. Слова через пробел. Последнее слово нужно
        // подобрать по длине. Затем:
        //   Определить время работы кода (тут удобно использовать
        //   System.currentTimeMillis() или аналог).
        //   Ускорить процесс, используя класс StringBuilder (сделать новый метод).
        //   Определить и вывести выигрыш в скорости (в микросекундах).
        System.out.println("C.2");
        // Миллион значений долго (String: около 70 000, StringBuilder: около 100),
        // для примера 100 000
        TaskC.competitions(text, 100000);
    }
}
