...
public class Runner02_01 {
    public static void main(String[] args) {
        ...
        //  В данном классе (Runner02_01) выполнены задания по темам:
        // 'Потоки выполнения часть 1' - JD02_01/лз.01
        // 'Потоки выполнения часть 2' - JD02_02/лз.02

        //      Программа моделирующая поток покупателей в магазине
        // 1. - Каждую секунду в магазин приходят от 0 до 4 ('чтобы увидеть работу 5-ти касс')
        ...
        //          }
        //  4. - Каждый покупатель реализовал интерфейс IUseBacket
        //          public interface IUseBacket {
        //              void takeBacket(); //взял корзину  - 0,1..0,2 сек
        //              void putGoodsToBacket(); //положил выбранный товар в корзину  - 0,1..0,2 сек
        //          }
        //     - Время на каждую операцию от 0,1 до 0,2 секунд, итог операции выводиться в консоль.
        //     - У каждого покупателя с корзиной (Backet) собирается набор от 1..4 товаров
